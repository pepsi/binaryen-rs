...
fn bindgen_test_layout_BinaryenLiteral__bindgen_ty_1() {
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<BinaryenLiteral__bindgen_ty_1>())).i32 as *const _ as usize
        },
        0usize,
        concat!(
            "Offset of field: ",
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<BinaryenLiteral__bindgen_ty_1>())).i64 as *const _ as usize
        },
        0usize,
        concat!(
            "Offset of field: ",
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<BinaryenLiteral__bindgen_ty_1>())).f32 as *const _ as usize
        },
        0usize,
        concat!(
            "Offset of field: ",
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<BinaryenLiteral__bindgen_ty_1>())).f64 as *const _ as usize
        },
        0usize,
        concat!(
            "Offset of field: ",
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<BinaryenLiteral__bindgen_ty_1>())).v128 as *const _ as usize
        },
        0usize,
        concat!(
            "Offset of field: ",
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<BinaryenLiteral__bindgen_ty_1>())).func as *const _ as usize
        },
        0usize,
        concat!(
            "Offset of field: ",
...
fn bindgen_test_layout_BinaryenLiteral() {
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<BinaryenLiteral>())).type_ as *const _ as usize },
        0usize,
        concat!(
            "Offset of field: ",
...
fn bindgen_test_layout_BinaryenBufferSizes() {
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<BinaryenBufferSizes>())).outputBytes as *const _ as usize },
        0usize,
        concat!(
            "Offset of field: ",
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<BinaryenBufferSizes>())).sourceMapBytes as *const _ as usize
        },
        8usize,
        concat!(
            "Offset of field: ",
...
fn bindgen_test_layout_BinaryenModuleAllocateAndWriteResult() {
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<BinaryenModuleAllocateAndWriteResult>())).binary as *const _
                as usize
        },
        0usize,
        concat!(
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<BinaryenModuleAllocateAndWriteResult>())).binaryBytes as *const _
                as usize
        },
        8usize,
        concat!(
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<BinaryenModuleAllocateAndWriteResult>())).sourceMap as *const _
                as usize
        },
        16usize,
        concat!(
